...
const Vertretungsplan: React.FC = () => {
  ...
  const fetchPlan = async () => {
    const response = await fetch('https://jsonendpoint.com/my-unique/endpoint/x6j0t'); //TODO: Ändere dies zur Firebase API
    const data = await response.json();
    setPlan(data);
    console.debug("Fetched Data")
    // TODO: Potentielle Zwischenspeicherung der Ergebnisse für Offline support
  };
